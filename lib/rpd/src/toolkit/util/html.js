module.exports = function (Rpd) {
  ...
  Rpd.channelrenderer(
    "util/wholenumber",
    "html",
    Rpd.allChannelRenderers["util/number"]["html"]
  );
    ...
    first: function (bodyElm) {
      ...
      return {
        "user-value": {
          ...
          valueOut: Kefir.fromEvents(valInput, "change").map(function () {
            return valInput.value;
          }),
        },
      };
  ...
  Rpd.noderenderer("util/bounded-number", "html", function () {
    ...
    return {
      ...
      first: function (bodyElm) {
        ...
        return {
          spinner: {
            valueOut: changes.map(function (val) {
      ...
      always: function (bodyElm, inlets) {
        ...
        spinnerElm.innerText = spinnerElm.textContent = spinner.setValue(
          inlets.spinner
        );
      },
    };
  ...
  Rpd.noderenderer("util/log", "html", function () {
    ...
    return {
      ...
      always: function (bodyElm, inlets, outlets) {
        ...
        textElm.textContent = textElm.innerText =
  ...
  Rpd.noderenderer("util/bang", "html", function () {
    ...
    return {
      ...
      first: function (bodyElm) {
        ...
        return {
          trigger: {
            valueOut: bangClicks.map(function () {
              return {};
            }),
          },
        };
                    ...
                    nodeTypesByToolkit[toolkit].types.forEach(function (
                      ...
                      ul.append("li").call(function (li) {
                        ...
                        li.append("span")
                          ...
                          .text(
                            nodeTypeIcons[nodeType] || String.fromCharCode(160)
                          );
                        li.append("span")
                          ...
                          .call(function (span) {
                            span
                              .append("span")
                              .attr("class", "rpd-nodelist-toolkit")
                              .text(nodeTypeDef.toolkit);
                            span
                              .append("span")
                              .attr("class", "rpd-nodelist-separator")
                              .text("/");
                            span
                              .append("span")
                              .attr("class", "rpd-nodelist-typename")
                              .text(nodeTypeDef.name);
                          });
    ...
    Kefir.fromEvents(element, "mousedown")
      ...
      .flatMap(function (startPos) {
        ...
        return Kefir.fromEvents(document.body, "mousemove")
          ...
          .map(function (newPos) {
            return start + (newPos.x - startPos.x);
          })
          .onValue(function (num) {
            spinner.incoming.emit(num);
          });
      })
      .onEnd(function () {});
  ...
  Spinner.prototype.checkValue = function () {
    if (isNaN(this.value) || this.value < this.min) {
      this.value = this.min;
      this.incoming.emit(this.min);
    }
    if (this.value > this.max) {
      this.value = this.max;
      this.incoming.emit(this.max);
    }
    return this.value;
  };
