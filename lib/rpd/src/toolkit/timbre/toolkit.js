module.exports = function (Rpd) {
  Rpd.channeltype("timbre/t-num", {
    allow: ["util/number"],
    adapt: function (v) {
      return !isNaN(v) ? T(v) : v;
    },
    accept: function (n) {
      return !isNaN(n) || (n && n.value);
    },
    show: function (t_num) {
  ...
  Rpd.channeltype("timbre/t-obj", {
    show: function (val) {
      return val ? "[Some]" : "[None]";
    },
  });
  ...
  Rpd.nodedescription(
    "timbre/play",
    "Play a given sound. Control your volume safely."
  );
