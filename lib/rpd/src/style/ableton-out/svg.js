module.exports = function (Rpd) {
  Rpd.style("ableton-out", "svg", function (config) {
    var ƒ = Rpd.unit;
    ...
    return {
      ...
      createNode: function (node, render, description, icon) {
        var minContentSize = render.size
          ? { width: render.size.width || 40, height: render.size.height || 40 }
          : { width: 70, height: 40 };
        ...
        nodeElm
          ...
          .attr(
            "d",
            roundedRect(0, 0, width, headerHeight, roundness, roundness, 0, 0)
          );
        nodeElm
          .append("text")
          .attr("class", "rpd-name")
        ...
        var outletsGroup = nodeElm
          ...
          .attr("transform", "translate(" + width + "," + headerHeight + ")");
        ...
        function checkNodeSize() {
          ...
          nodeElm
            ...
            .attr(
              "transform",
              "translate(" + newSize.width + "," + headerHeight + ")"
            );
          lastSize = newSize;
        }
