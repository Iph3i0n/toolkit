        ...
        return {
          ...
          createNode: function (node, render, description, icon) {
            ...
            var processGroup = nodeElm
              ...
              .attr(
                "transform",
                "translate(" + width * pivot.x + "," + height * pivot.y + ")"
              );
          ...
          createInlet: function (inlet, render) {
            ...
            var nextX =
              socketsMargin +
              nodeToInlets[inlet.node.id].length * socketPadding;
          ...
          createOutlet: function (outlet, render) {
            ...
            var nextX =
              socketsMargin +
              nodeToOutlets[outlet.node.id].length * socketPadding;
