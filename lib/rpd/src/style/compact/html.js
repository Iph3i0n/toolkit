module.exports = function (Rpd) {
  Rpd.style("compact", "html", function (config) {
    var lastCanvas;
    ...
    return {
      ...
      createNode: function (node, render, description, icon) {
          ...
          .call(function (tr) {
            tr.append("td")
              ...
              .call(function (td) {
                ...
                if (config.showTypes)
                  td.append("span").attr("class", "rpd-type").text(node.type);
        ...
        return {
          ...
          size: render.size
            ? {
                width: render.size.width || 30,
                height: render.size.height || 20,
              }
            : { width: 30, height: 20 },
        };
      },
      ...
      createInlet: function (inlet, render) {
        var inletElm = d3
          ...
          .call(function (td) {
            ...
            if (config.showTypes)
              td.append("span").attr("class", "rpd-type").text(inlet.type);
          });
      ...
      createOutlet: function (outlet, render) {
        var outletElm = d3
          ...
          .call(function (td) {
            ...
            if (config.showTypes)
              td.append("span").attr("class", "rpd-type").text(outlet.type);
          });
