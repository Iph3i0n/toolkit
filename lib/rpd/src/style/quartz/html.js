    ...
    return {
      ...
      createNode: function (node, render, description, icon) {
        ...
        nodeElm
          ...
          .call(function (thead) {
            thead
              ...
              .call(function (th) {
                if (config.showTypes)
                  th.append("span").attr("class", "rpd-type").text(node.type);
                if (icon)
                  th.append("span").attr("class", "rpd-icon").text(icon);
                th.append("span")
                  .attr("class", "rpd-name")
            ...
            tbody
              ...
              .call(function (tr) {
                tr.append("td")
                  ...
                  .append("tbody")
                  .append("div")
                  .attr("class", "rpd-inlets-target"); // -> node/add-inlet
              })
              // node body
              .call(function (tr) {
                tr.append("td")
                  ...
                  .append("td")
                  .append("div")
                  .attr("class", "rpd-process-target"); // -> node/process
              })
              // outlets placeholder
              .call(function (tr) {
                tr.append("td")
                  ...
                  .append("tbody")
                  .append("div")
                  .attr("class", "rpd-outlets-target"); // -> node/add-outlet
              });
          });
        ...
        return {
          ...
          size: render.size
            ? {
                width: render.size.width || 70,
                height: render.size.height || 30,
              }
            : { width: 70, height: 30 },
        };
      },
      ...
      createInlet: function (inlet, render) {
        var inletElm = d3
          .select(document.createElement("tr"))
          ...
          .call(function (tr) {
            ...
            if (config.showTypes)
              tr.append("td").attr("class", "rpd-type").text(inlet.type);
          });
      ...
      createOutlet: function (outlet, render) {
        var outletElm = d3
          ...
          .call(function (tr) {
            ...
            if (config.showTypes)
              tr.append("td").attr("class", "rpd-type").text(outlet.type);
            tr.append("td")
              .attr("class", "rpd-name")
